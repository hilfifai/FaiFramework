        ...
        public static function default_card_vertical($page)
    {
        ...
        $return["row_start"] = file_exists($base . "default_card_vertical.row_start.php") ? file_get_contents($base . "default_card_vertical.row_start.php") : "";
        $return["html"] = file_exists($base . "default_card_vertical.html.php") ? file_get_contents($base . "default_card_vertical.html.php") : "";
        $return["row_end"] = file_exists($base . "default_card_vertical.row_end.php") ? file_get_contents($base . "default_card_vertical.row_end.php") : "";
        return $return;
    }
        ...
        public static function hibe3_card_vertical($page)
    {
        ...
        $return["row_start"] = file_exists($base . "hibe3_card_vertical.row_start.php") ? file_get_contents($base . "hibe3_card_vertical.row_start.php") : "";
        $return["col_start"] = file_exists($base . "hibe3_card_vertical.col_start.php") ? file_get_contents($base . "hibe3_card_vertical.col_start.php") : "";
        $return["html"] = file_exists($base . "hibe3_card_vertical.html.php") ? file_get_contents($base . "hibe3_card_vertical.html.php") : "";
        $return["col_end"] = file_exists($base . "hibe3_card_vertical.col_end.php") ? file_get_contents($base . "hibe3_card_vertical.col_end.php") : "";
        $return["row_end"] = file_exists($base . "hibe3_card_vertical.row_end.php") ? file_get_contents($base . "hibe3_card_vertical.row_end.php") : "";
        return $return;
    }
        ...
        public static function form_search_header($page)
    {
        ...
        $return["form"] = file_exists($base . "form_search_header.form.php") ? file_get_contents($base . "form_search_header.form.php") : "";
        $return["name_search"] = file_exists($base . "form_search_header.name_search.php") ? file_get_contents($base . "form_search_header.name_search.php") : "";
        $return["name_category"] = file_exists($base . "form_search_header.name_category.php") ? file_get_contents($base . "form_search_header.name_category.php") : "";
        return $return;
    }
        ...
        public static function foodmart_card_vertical($page)
    {
        ...
        $return["row_start"] = file_exists($base . "foodmart_card_vertical.row_start.php") ? file_get_contents($base . "foodmart_card_vertical.row_start.php") : "";
        $return["col_start"] = file_exists($base . "foodmart_card_vertical.col_start.php") ? file_get_contents($base . "foodmart_card_vertical.col_start.php") : "";
        $return["html"] = file_exists($base . "foodmart_card_vertical.html.php") ? file_get_contents($base . "foodmart_card_vertical.html.php") : "";
        $return["col_end"] = file_exists($base . "foodmart_card_vertical.col_end.php") ? file_get_contents($base . "foodmart_card_vertical.col_end.php") : "";
        $return["row_end"] = file_exists($base . "foodmart_card_vertical.row_end.php") ? file_get_contents($base . "foodmart_card_vertical.row_end.php") : "";
        return $return;
    }
        ...
        public static function ashion_card_vertical($page)
    {
        ...
        $return["row_start"] = file_exists($base . "ashion_card_vertical.row_start.php") ? file_get_contents($base . "ashion_card_vertical.row_start.php") : "";
        $return["col_start"] = file_exists($base . "ashion_card_vertical.col_start.php") ? file_get_contents($base . "ashion_card_vertical.col_start.php") : "";
        $return["html"] = file_exists($base . "ashion_card_vertical.html.php") ? file_get_contents($base . "ashion_card_vertical.html.php") : "";
        $return["col_end"] = file_exists($base . "ashion_card_vertical.col_end.php") ? file_get_contents($base . "ashion_card_vertical.col_end.php") : "";
        $return["row_end"] = file_exists($base . "ashion_card_vertical.row_end.php") ? file_get_contents($base . "ashion_card_vertical.row_end.php") : "";
        return $return;
    }
