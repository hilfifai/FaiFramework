...
class AuthArrayContent{

    public static function login_array_1($page)
	{
		
		$array['login-database'] = "apps_user";
		$array['login-row'] = array("primary_key" => "id_apps_user", "step" => "daftar_step");
		$array['login-session-utama'] = array("session_name" => "id_apps_user", "database_row" => "id_apps_user");
		$array['login-session'] = array(
		...
		$array['login-daftar-hak_akses'] = "user";

        
		$array['login-array'] = array(
			"field" => array("username" => array("username", "email"), "password" => array("password")),
			"content" => ["auth_content","login_page_1","login"]

		);
		//<div class="row justify-content-center">
		
		
		// daftar array itu terkait nantinya akan jadi dibuat perhalaman, dengan pages_contentnya adalah controller 

		$array['login-daftar-array'] = array(
			"type" => "wizard",
			"first" => "1",
			"step" => array(
				"1" => array(
					...
					"function_crud" => array(
						...
						"unique_value" => array(
							...
							array(
								"database" => array(
									"utama" => $array['login-database'],
									"primary_key" => $array['login-row']['primary_key'],
								)
							),
							"username" => array(
								"database" => array(
