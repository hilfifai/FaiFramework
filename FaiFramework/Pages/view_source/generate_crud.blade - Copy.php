...
<form action="#" id="form" class="form-horizontal">
	...
	<div class="code">
		...
		<textarea id="dataView" data-id="add" name="view[add]" style="width: 100%;height:100%"><?php

																								include($app_framework . "/_ViewCrudAdd.php");
																								$page = $page_temp;
																								?>
	</textarea>
	</div>
	<div class="code">
		...
		<textarea id="dataEdit" data-id="edit" name="view[edit]" style="width: 100%;height:100%"><?php
																									include($app_framework . "/_ViewCrudEdit.php");
																									$page = $page_temp; ?>
	</textarea>
	</div>
	<div class="code">
		...
		<textarea id="dataView" data-id="view" name="view[view]" style="width: 100%;height:100%"><?php
																									include($app_framework . "/_ViewCrudView.php");
																									$page = $page_temp; ?>
	</textarea>
	</div>
	<div class="code">
	...
	for ($i = 0; $i < count($array); $i++) {
		...
		$field = $array[$i][1];
		$type = $array[$i][2];
		$extypearray = explode('-', $type);
		if (in_array('appr', $extypearray)) {
			$visible = true;
		}
	}
	...
	?>
		<div class="code">
			...
			<textarea id="dataJS" name="view[appr]" style="width: 100%;height:100%"><?php
																					include($app_framework . "/_ViewCrudAppr.php");
																					$page = $page_temp; ?>
	</textarea>
		</div>
		<div class="code">
			...
			<textarea id="dataJS" name="view[view_appr]" style="width: 100%;height:100%"><?php
																							include($app_framework . "/_ViewCrudViewAppr.php");
																							$page = $page_temp; ?>
	</textarea>
		</div>
	<?php } ?>
