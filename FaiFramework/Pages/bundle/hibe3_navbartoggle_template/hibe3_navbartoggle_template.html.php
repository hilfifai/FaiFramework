<button class="navbar-toggler" onclick="togle_sidebar_wai()" type="button" id="btnSidebarWAI" style="display: block;font-size: 25px;width: 10%;text-align: left;padding-left:0px;border: 0px;color: white;">
