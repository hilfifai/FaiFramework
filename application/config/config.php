...
$folder = ''; // default kosong

// Cek kalau running di localhost
if ($host == 'localhost') {
    $folder = '/frameworkServer_v1/index.php/'; // ganti ini dengan nama folder project
}
if ($host == '192.168.70.159') {
    $folder = '/frameworkServer_v1'; // ganti ini dengan nama folder project
}
