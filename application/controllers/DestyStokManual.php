...
class DestyStokManual extends CI_Controller
{
    public function update_stok_excel()
    {
        $this->load->view('DestyManualUpload');
    }
    ...
    public function proses_data_excel_to_database()
    {
...
-- ----------------------------
    ...
    public function desty_data_to_inventaris()
    {
        try {
        $fai = new MainFaiFramework();
    ...
    public function manual_produk_sync_utama()
    {
        $fai = new MainFaiFramework();
...
$(document).ready(function() {
    ...
    public function manual_produk_sync_varian()
    {
		...
		function tambahkanSlashJikaDiAkhir($kalimat) {
			...
			$kata_kunci = ['koko', 'gamis'];
			 ...
			 foreach ($kata_kunci as $kata) {
				...
				if ($panjang_kalimat > $panjang_kata && 
...
<script>
  ...
  function sync_sarimbit_ethica_barang(id_barang_master,id_desty_master,id_varian_desty,typess){
    ...
    }public function sync_artikel_ethica($search)
    {
        $fai = new MainFaiFramework();
	...
	public function sync_sarimbit_ethica_barang()
    {
        $fai = new MainFaiFramework();
    ...
    public function proses_inisiasi_generate_data($tipe)
    {
        $fai = new MainFaiFramework();
	...
	public function inisisasi_to_storage_store_produk()
    {
		ob_start();
		$fai = new MainFaiFramework();
...
inventaris__asset__list__varian.*				";
	...
	public function inisisasi_to_storage_desty_manual()
    {
		ob_start();
		$fai = new MainFaiFramework();
	...
	public function inisisasi_to_storage()
    {
		echo "
