		...
		public function Hari_Jam_menit_Detik_Number_Abjad()
			...
			}public function generate_Hari_Jam_menit_Detik_Number_Abjad()
			{
				...
				$this->load->view("enskripsi_generate/en");
			}
			...
			public function Tanggal_Number()
			{
				...
				if(in_array($a."-".$b,$lines)){
					...
					echo $a."-".$b."<br>";
					$content = "else if($this->iuwcBE9pOzfOasfHOi70lv46647rnzsMPUZSMPUZSv4664Nvoqs4Fsnw6c3Kg37YTERMO3Mpcik5iKaOcrLPxM==$b  and $this->iuwcBE9pOzfOasfHOi70lv46647rnzsMPUZSMPUZSv4664Nvoqs4Fsnw6c3Kg37YTERMO3Mpcik5iKaOcrLPxM==$c)
						$this->Sfr6p8RVFbxcb7VH62tM362tM3iMYh4i72gzCqhdYWcBMS ="'.$folderr[rand(0,1500)].'";";
					$fp = fopen("Tanggal_Number_result.be3", "w");
					fwrite($fp,$content);
					fclose($fp);
			...
			public function Hari_Number_Abjad()
			{
				...
				if(in_array($a."-".$b,$lines)){
					...
					echo $a."-".$b."<br>";
					$content = "else if($this->G1aqxxVkwdwfa2zHafapk7xJvKoxRSioV2hiwWTb7qwPKNK60PNE3KXavg12zKV59hoxRSiwWTb71y3Nfvg12zohLMy7xJvKGLY8b==$b  and $this->G1aqxxVkwdwfa2zHafapk7xJvKoxRSioV2hiwWTb7qwPKNK60PNE3KXavg12zKV59hoxRSiwWTb71y3Nfvg12zohLMy7xJvKGLY8b==$c)
						$this->Sfr6p8RVFbxcb7VH62tM362tM3iMYh4i72gzCqhdYWcBMS ="'.$folderr[rand(0,1500)].'";";
					$fp = fopen("Hari_Number_Abjad_result.be3", "w");
					fwrite($fp,$content);
					fclose($fp);
