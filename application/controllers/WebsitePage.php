...
class WebsitePage extends CI_Controller {
	...
	{
			$route_page = base_url().'WebsitePage/all_page';
			...
			$fai = new MainFaiFramework();
				...
				$page['load']['sidebar'] = $fai->Apps('Website','menu_topic');;
				$page['load']['route_page'] = $route_page;
				$page['load']['apps'] = 'Website';
				$page['load']['page_view'] = 'topic__page';
				$page['load']['type'] = 'view_website'; 
				$page['load']['id'] = '-1';
				$page['load']['menu'] = '-1';
	...
	public function admin_page()
	{
			...
			$route_page = base_url().'WebsitePage/admin_page';
			$page['app_framework'] ='ci';
			$page['database_provider'] ='postgres';
			$page['database_name'] ='be3';
			...
			$fai = new MainFaiFramework();
				...
				$page['load']['sidebar'] = $fai->Apps('Website','menu_topic');;
				$page['load']['route_page'] = $route_page;
				$page['load']['apps'] = 'Inventaris_aset';
				$page['load']['page_view'] ='asset_list';
