async function initialize_checkout() {
    ...
    const db = await openDB(transaksiDB, [storeName, "store__toko__user"]);
    // const db2 = await openDB(transaksiDB, "store__toko__user");
    ...
    list_bangunan = JSON.parse(allData[getalldata.myApp.page.load.load_page_id].list_bangunan);
...
<div id="pesanan-ecomerce" class="card card-body mt-3" style="display:none">
            ...
            if (selected_bangunan) {
                ...
                if (allData[getalldata.myApp.page.load.load_page_id].utama.id_kirim_ke) {
                    if (data_bangunan.primary_key2 == allData[getalldata.myApp.page.load.load_page_id].utama
                        ...
                        id_selected = data_bangunan.primary_key2;
                    }
                } else if (data_bangunan.default_pembelian_barang == 1) {
                    selected_bangunan = get_bangunan;
                    id_selected = data_bangunan.primary_key2;
    ...
    list_toko = JSON.parse(allData[getalldata.myApp.page.load.load_page_id].list_toko);
    list_produk = JSON.parse(allData[getalldata.myApp.page.load.load_page_id].list_produk);
    ...
    list_toko.forEach(data_toko => {
        ...
        get_toko += `</div></div></div>
				<div id="pilih-ongkir-${data_toko.id_toko}" style="display:none;margin: 30px;">`;
                    ...
                    <div class="card card-bordered shadow-none mb-2">
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                                <input class="form-check-input" type="radio"  name="pilih_ongkir-${data_toko.id_toko}"   value="${data_ekspedisi.kode_ekspedisi}-${data_ekspedisi.kode_service}-${data_ekspedisi.id_ekspedisi}-${data_ekspedisi.id_service}"data-gtm-form-interact-field-id="2" style="border: 2px solid black;">
